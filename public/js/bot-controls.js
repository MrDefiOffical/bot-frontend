...
function startBot() {
  ...
  document.getElementById("statusText").textContent = "mrdefi Active";

  addLogMessage("mrdefi started with stop-loss threshold: $" + stopLossPrice);
...
async function stopBot() {
  ...
  document.getElementById("statusText").textContent = "mrdefi Paused";
